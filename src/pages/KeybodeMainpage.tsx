    ...
    <div>
        <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div>
                ...
                <img src="/imges/mirim.png" alt="Description" style={{height:"140px", width:"140px"}}/>
            </div>
            </div>
            <div style={{
        ...
        <div style={{
                ...
                <p style={{
                    ...
                    marginLeft:"20px",
                    position: "relative",  
                    top: "10px" }}>public static void main(String[] args){'{'}</p>
                <p style={{
                    fontSize: "20px",
                    marginLeft:"30px",
                    position: "relative",  
                     }}>int a = 1; int b = 2; int c = 3;</p>
                <p style={{
                    fontSize: "20px",
                    marginLeft:"30px",
                    position: "relative",  
